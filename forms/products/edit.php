                    ...
                    <div class="col-5 col-lg-4 scroll-y modal-h">
                        <form id="{{_form}}EditForm">
                            ...
                            <div>
                                ...
                                <div class="form-group row mb-1">
                                    <label class="col-form-label col-md-4">Скорость потока</label>
                                    <div class="col-sm-8">
                                        <select class="form-control" name="speed" multiple wb-select2 placeholder="Скорость потока">
                                ...
                                <div class="form-group row mb-1">
                                    <label class="col-form-label col-md-4">Мед. направления</label>
                                    <div class="col-sm-8">
                                        <select class="form-control" name="directions" multiple wb-select2 placeholder="Медицинские направления">
