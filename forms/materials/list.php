                ...
                {{#each result}}
                    <li class="list-group-item d-flex align-items-center" data-id="{{.id}}">
                        ...
                        <div class="text-right wd-20p">
                            ...
                            <a href="javascript:" data-ajax="{'url':'/cms/ajax/form/materials/edit/{{.id}}','html':'modals'}" class="d-inline">
...
<script language="javascript" src="/forms/materials/list.js"></script>
