...
$(document).ready(function(){new Swiper(".main-slider",{slidesPerView:1,watchOverflow:!0,loop:"infinite",effect:"fade",autoplay:{delay:5e3,disableOnInteraction:!1},pagination:{el:".swiper-pagination",clickable:!0,renderBullet:function(e,i){return"<button class='"+i+"'><svg class='progress' width='41' height='41'><circle class='circle-origin' r='20' cx='20.5' cy='20.5'></circle></svg><span></span></div>"}}}),new Swiper(".news-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:40,navigation:{nextEl:".news .swiper-button-next",prevEl:".news .swiper-button-prev"},breakpoints:{10:{slidesPerView:1,spaceBetween:16},500:{slidesPerView:2,spaceBetween:16},769:{slidesPerView:"auto",spaceBetween:40}}}),new Swiper(".purpose-slider",{slidesPerView:4,watchOverflow:!0,spaceBetween:24,navigation:{nextEl:".purpose .swiper-button-next",prevEl:".purpose .swiper-button-prev"},breakpoints:{10:{slidesPerView:2,spaceBetween:16},400:{slidesPerView:2,spaceBetween:16},540:{slidesPerView:3,spaceBetween:16},769:{slidesPerView:4,spaceBetween:24}}}),new Swiper(".buy-slider",{slidesPerView:"auto",watchOverflow:!0,spaceBetween:40,navigation:{nextEl:".buy .swiper-button-next",prevEl:".buy .swiper-button-prev"},breakpoints:{10:{slidesPerView:1,spaceBetween:16},500:{slidesPerView:2,spaceBetween:16},769:{slidesPerView:"auto",spaceBetween:40}}}),new Swiper(".partners-slider",{slidesPerView:4,watchOverflow:!0,spaceBetween:40,navigation:{nextEl:".partners .swiper-button-next",prevEl:".partners .swiper-button-prev"},breakpoints:{10:{slidesPerView:2},400:{slidesPerView:2},540:{slidesPerView:3},769:{slidesPerView:4}}}),new Swiper(".event-slider",{slidesPerView:1,watchOverflow:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),new Swiper(".direction-slider",{slidesPerView:1,watchOverflow:!0,navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}});$(".header-bar,.header-bg").on("click",function(){$("body").toggleClass("header-active")}),$(".tab-list li a").on("click",function(e){e.preventDefault(),$(this).parents(".tab-list").find("a").removeClass("active"),$(this).parents(".allTabs").find(".tab").removeClass("tab-active");var i=$(e.target).attr("href");$(i).addClass("tab-active"),$(this).addClass("active")}),$(".about-img-main-img").hover(function(){$(".about-md,.about-img-main-img").removeClass("active"),$("#"+$(this).attr("data-md")).addClass("active"),$(this).addClass("active")},function(){}),$(".about-md .close-ico").on("click",function(){$(this).parents(".about-md").removeClass("active"),$(".about-img-main-img").removeClass("active")}),$(document).on("click",function(e){var i=$(".about-img");i.is(e.target)||0!==i.has(e.target).length||$(".about-md,.about-img-main-img").removeClass("active")}),$(".direction-item-imgs").hover(function(){$(".direction-item,.direction-item-info").removeClass("active"),$("#"+$(this).attr("data-direction")).addClass("active"),$(this).hasClass("direction-item-imgs")?$(this).parents(".direction-item").addClass("active"):$(".direction-bg").addClass("active")},function(){}),$(".direction-slide .more-btn").on("click",function(e){e.preventDefault(),$(".direction-item,.direction-item-info").removeClass("active"),$("#"+$(this).attr("data-direction")).addClass("active"),$(this).hasClass("direction-item-imgs")?$(this).parents(".direction-item").addClass("active"):$(".direction-bg").addClass("active")}),$(".direction-item-info .close-ico").on("click",function(){$(".direction-item,.direction-item-info,.direction-bg").removeClass("active")}),$(document).on("click",function(e){var i=$(".direction-item,.direction-item-info,.direction-slide");i.is(e.target)||0!==i.has(e.target).length||$(".direction-item,.direction-item-info,.direction-bg").removeClass("active")}),$('[data-fancybox=""]').fancybox({autoFocus:!1,autoCenter:!1,touch:!1}),$(".link-youtube").fancybox({openEffect:"none",closeEffect:"none",helpers:{media:{}}})});

$('a[fancyfix][href^="#"]').click(function() {
...
if ($('iframe.material').length) {
    let $ifr = $('iframe.material')
