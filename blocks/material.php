    ...
    <section class="event">
        <div class="wrapper" itemscope itemtype="https://schema.org/Article">
            ...
            <div class="event-all">
                ...
                <a data-fancybox="" data-type="iframe" wb-if="'{{_parent.materials}}' == 'video' && '{{_sess.user.role}}'>''" href="{{video}}" class="link-youtube event-img" style="background-image: url({{_var.video_cover}});"></a>
